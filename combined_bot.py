...
# Signal storage
SIGNALS_FILE = "combined_signals.json"
PERFORMANCE_FILE = "combined_performance.json"
...
async def automatic_signal_loop():
...
async def main():
    """Main function - runs both automatic and interactive features"""
    print("🚀 Starting Combined Trading Signals Bot...")
    print("=" * 60)
    ...
    asyncio.create_task(automatic_signal_loop())
    
    print("✅ Combined bot started successfully!")
